...
DATABASES = {"default": env.db("DATABASE_URL", default="postgres://Misha-Molokov:misha12345@127.0.0.1:5432/PythonDev")}
...
ADMINS = [("""misha""", "misha@example.com")]
...
SPECTACULAR_SETTINGS = {
    ...
    "SERVERS": [
        ...
        {"url": "https://misha", "description": "Production server"},
    ],
}
# Your stuff...
# ------------------------------------------------------------------------------
